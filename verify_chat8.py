...
async def main():
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.screenshot(path='/home/jules/verification/screenshots/verification_success8.png')

        except Exception as e:
            print(f"Error interacting with chat: {e}")
            await page.screenshot(path='/home/jules/verification/screenshots/verification_error8.png')
